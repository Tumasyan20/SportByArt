...
router.get('/list/:page', Authenticate, userController.getUsers);               //? route for get user list
router.get('/:id', Authenticate, userController.getUser);                 //? Route for get user info
