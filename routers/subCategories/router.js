...
router.get('/list/c/:categoryId', subCategoryController.subCategoriesById);             //? Route for get category subcategories
router.get('/list/s/:id', subCategoryController.getArticlesBySubCategory);              //? Route for get articles by sub category
